...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_AddFilter.setText(_translate("Form", "Add Filter"))
        self.pushButton_DeleteFilter.setText(_translate("Form", "Delete Filter"))
        self.pushButton_MoveFilterUp.setText(_translate("Form", "Move Up"))
        self.pushButton_MoveFilterDown.setText(_translate("Form", "Move Down"))
        self.label_10.setText(_translate("Form", "Filter Name:"))
        self.label_2.setText(_translate("Form", "Filter Command:"))
