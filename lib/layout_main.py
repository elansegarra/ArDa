...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 417, 985))
        ...
        self.formLayout.setItem(20, QtWidgets.QFormLayout.LabelRole, spacerItem3)
        spacerItem4 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout.setItem(20, QtWidgets.QFormLayout.FieldRole, spacerItem4)
        ...
        self.textEdit_Abstract = QtWidgets.QTextEdit(self.scrollAreaWidgetContents_2)
        self.textEdit_Abstract.setFrameShape(QtWidgets.QFrame.Box)
        self.textEdit_Abstract.setLineWidth(0)
        self.textEdit_Abstract.setObjectName("textEdit_Abstract")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.textEdit_Abstract)
        ...
        self.lineEdit_Something = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_2)
        self.lineEdit_Something.setAcceptDrops(False)
        self.lineEdit_Something.setFrame(False)
        self.lineEdit_Something.setObjectName("lineEdit_Something")
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.lineEdit_Something)
        ...
        self.lineEdit_Pages_4 = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_Pages_4.sizePolicy().hasHeightForWidth())
        self.lineEdit_Pages_4.setSizePolicy(sizePolicy)
        self.lineEdit_Pages_4.setAcceptDrops(False)
        self.lineEdit_Pages_4.setFrame(False)
        self.lineEdit_Pages_4.setObjectName("lineEdit_Pages_4")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.lineEdit_Pages_4)
