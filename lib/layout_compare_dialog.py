...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.plainTextEdit_Description.setMaximumSize(QtCore.QSize(16777215, 75))
        self.plainTextEdit_Description.setAcceptDrops(False)
        self.plainTextEdit_Description.setAutoFillBackground(False)
        self.plainTextEdit_Description.setStyleSheet("background-color: rgb(240, 240, 240)")
        self.plainTextEdit_Description.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.plainTextEdit_Description.setReadOnly(True)
        self.plainTextEdit_Description.setBackgroundVisible(False)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 819, 702))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Document Comparison"))
        self.plainTextEdit_Description.setPlainText(_translate("Dialog", "Something something (directions)"))
        self.label_RightTitle.setText(_translate("Dialog", "(<- check all) Document 2"))
        self.label_LeftTitle.setText(_translate("Dialog", "Document 1 (check all ->)"))
